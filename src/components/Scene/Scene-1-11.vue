...
<template>
  <Modal title="" description="" type="short" x="right">
    <p class="text-left text-3xl lg:text-[2.5rem] lg:leading-[3rem]" v-html="'Would you store your<br/>multiple online profiles<br/>and data securely in a<br/>single vault?'" />
