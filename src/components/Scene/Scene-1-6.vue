...
<template>
  <Container :x="modal.state.x" :y="modal.state.y" :scale="modal.state.scale">
    <Sprite :texture="modal.image" :texture-options="textureOptions" :anchor="0.5" :scale="isMobile ? 2 : 0.5" />
        ...
        <section ref="targetElem" class="policy-section cms-content section-legal h-[50vh]">
          <div class="container">
            <article>
              ...
              <p class="paragraph">
                Affinidi Pte. Ltd., a private limited company, incorporated in Singapore and having its registered
                office address at 83 Clemenceau Avenue, Singapore 239920 (“Affinidi” and / or “We”
                and / or “Us”) is a com-pany in the field of information technology. One of our key services is the
                provision of a data vault called Affinidi Vault, allowing end users (“Consumer”) to
                own, collect and store their data and selectively share it with participating website and app operators
                (“Developer”) in a privacy-enabled and consent-driven manner. In order to do so,
                We enable the Developer to implement a login system called Affinidi Login for his/her services, allowing
                Consumer to log in with his/her data stored in the Affinidi Vault. In this way,
                We allow the Developer to use authentication processes with decentralized data storage without having to
                collect data from Consumer during the login or registration process. In this
                regard, We offer various services and products to the Developer as well as to Consumer, each of which is
                subject to these Terms and Conditions (“Terms &amp; Conditions”). Section 2 of
                the Terms &amp; Conditions shall apply to services and products we offer to the Developers. Section 3 of
                the Terms &amp; Conditions shall apply to services and products we offer to the
                Consumer. While Sections 4, 5, 7, 8 and 9 of the Terms &amp; Conditions contains partially deviating and
                / or supplementary provisions to Sections 2 and 3.
              </p>
              ...
              <div class="ms-md-5 ms-3">
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <p class="paragraph c11">
                    ...
                    Developer’s offer (hereinafter: “Agree-ment”). We are free to accept or deny the offer
                    at our own discretion.
                  </p>
                  <p class="paragraph c40">
                    <span class="c0">2.1.3.</span> We offer our Services according to section 2 to Developers, defined
                    as a natural or legal person who, at the time of concluding this Term and
                  ...
                  <p class="paragraph c78">
                    ...
                    parties in particular, he/she shall not sell, lend, rent or publicly reproduce
                    the content or make it accessible. The Developer shall not reverse engi-neer, disassemble,
                    decompile, except to the extent permitted by applicable mandatory law, or use it to train
                    any artificial intelligence model or application.
                  </p>
                  <p class="paragraph c111">
                    <span class="c0">2.1.5.</span> So far as our Services contain open-source software (“OSS”)
                    components, the use of these components is exclusively subject to the corresponding terms
                    and conditions of the respective OSS. No provision of the Terms &amp; Conditions shall affect the
                    rights or obligations of the De-veloper under the corresponding terms and
                    conditions of the OSS. In the event of contradic-tions or conflicting provisions between the license
                    terms of the OSS and the provisions of the Terms &amp; Conditions, the license
                ...
                <p class="paragraph c6">
                  Our Services do not only include one service or product but may include a number of respective
                  services, products and deliverables that the Developer has applied for by way of our
                  order process and that has been made part of the Agreement upon our acceptance and which may include
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <div class="ms-md-5 ms-4">
                    <p class="paragraph" style="padding-left: 65px">
                      ...
                      data storage on his/her website or app so that the Developer does not need to collect data
                    ...
                    <p class="paragraph" style="padding-left: 65px">
                      <span class="c0">2.2.1.3.</span> The service description and system requirements for using
                      Affinidi Vault in Appendix 4 shall apply accordingly.
                    </p>
                  </div>
                  ...
                  <p class="paragraph">
                    ...
                    Affinidi Portal, a web-based portal to access the documentation and other
                    content that We provide for the Developer to implement and use our Services. A service description
                    as well as the technical system requirements for using Affinidi Portal are set
                    out in Appendix 2.
                  </p>
                  ...
                  <div class="ms-md-5 ms-4">
                    ...
                    <p class="paragraph" style="padding-left: 65px">
                      ...
                      in order to implement our Services or parts thereof, the Developer may also use
                      a third party CLI or software component to implement and use Our Services, given that the third
                      party CLI or software component meets the required technical requirements as in
                      particular set out in the Terms &amp; Conditions. If a CLI or third-party software package is
                      used, the terms and conditions of the respective provider shall apply in this
                      regard. We shall not be responsible for and do not warrant that our Services are usable with any
                      particular third party CLI or soft-ware component or software-like tools. We
                      reserve the right to reject or exclude third party CLI providers if this becomes necessary for
                      weighty reasons . Weighty reasons are, for example, a technical incompatibility of
                      the service of the third-party provider with our Services, legal reasons that prevent the
                      connection to our Services or the adap-tation of our Services to technical innovations.
                    </p>
                  </div>
                  ...
                  <p class="paragraph">
                    ...
                    provide Developers with our Reference App, a demo version of our Services in
                    which the Developer can test our Services and their functionalities in parallel to the live
                    oper-ation of our Services. In order to be able to use Reference App, the Developer
                    needs Affinidi Vault. In this regard, sections 2.2.1 and 2.2.1.1 applies accordingly. Reference App
                    runs sepa-rately from the live operation of our Services. In particular, this
                    means that Reference App is not connected to Consumer's Affinidi Vault in the sense that Consumer
                    data is transferred from Affinidi Vault to Reference App. The Developer shall not
                    feed any real data from Consumers into Reference App and would be solely liable to the Consumer in
                    case they are adding such information on the Reference App.
                  </p>
                  ...
                  <p class="paragraph">
                    ...
                    previously un-locked Affinidi Vault in his/her browser by entering his/her biometric data. The use
                    of Affinidi Desktop App is not required for the use of Affinidi Vault, it is only
                  ...
                  <p class="paragraph">
                    ...
                    lim-ited to basic support in terms of Q&amp;A lists that we provide in the Affinidi Portal or in
                    case you have upgraded your subscription tier then you would be eligible to avail
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c56">
                    ...
                    Developer has subscribed to any tier (like Essential or Community tier or any
                    other tier as may be defined by us later), The Developer has the option to avail additional benefits
                    by upgrading to various other sub-scription tiers offered by Affinidi.
                  </p>
                  <p class="paragraph c56">
                    <span class="c0">2.3.2.</span> The subscription tiers may as well be subject to limitations with
                    respect to Monthly Active Users (“MAUs”), Affinidi Credits, Customer Support, etc.
                    as specified in the Developer Portal and/or www.affinidi.com/pricing (“Pricing Page”). When the
                    Developer’s actual usage of the Services reaches the limits or nears the limits as
                    specified under the various subscription tiers in the Developer Portal and/or the Pricing Page, we
                    may notify the Developer accordingly and suggest an upgrade of his subscription
                    tier; at our discretion but taking into account the Devel-oper’s interest we may also block any
                    further actions within the Services that would exceed the defined quota. Affinidi
                    can at their discretion charge overage for exceeding the MAUs or any other limitation as more
                    particularly specified under the Developer Portal and/or the Pric-ing Page. The
                    Developer will not be able to complete any further API call when the number of Credits in that
                    Developer’s account at the moment of request to the API call does not cover the
                    actually defined Credit cost. Further, the Developer may not be able to add users to their services
                    through Affinidi Services, in case they reach their maximum MAU limit. For the
                    pur-pose of this clause,
                  </p>
                  <div class="ms-md-5 ms-4">
                    <p class="paragraph" style="padding-left: 65px">
                      <span class="c0">2.3.2.1.</span> Affinidi Credits (“Credit(s)”) refers to credits provided by
                      Affinidi as a fair play mech-anism to the account of the Developer. Each
                      subscription tier has a predefined number of Credits allocated for API calls made for various
                      reasons. The number of Credits re-quired for each API call will depend on the
                      functionality within the Service and may be revised at any time with notice to the Developer.
                      Further, the performance of an API call in the course of using Our Services may
                      require the Developer to utilize Affinidi Credits made available to such Developer. The number of
                      Credits/MAUs within the Developer’s account will be reset according to his
                      subscribed tier at the beginning of every subscrip-tion cycle during the term of his/her active
                      subscription tier.
                    </p>
                    <p class="paragraph" style="padding-left: 65px">
                      <span class="c0">2.3.2.2.</span> MAUs refers to number of unique end-users/Consumers who have
                      successfully logged into any website configured under that project by the Developer
                      at least once in the given month.
                    </p>
                  </div>
                  <p class="paragraph c56">
                    <span class="c0">2.3.3.</span> The Developer may ask for an upgrade, downgrade, initiation, or
                    cancellation of a subscription tier which will become effective upon Our approval
                    with the effect of the following subscrip-tion cycle. Provided however in case of downgrade or
                    cancellation of a paid subscription, the Developer will have to inform Us minimum
                    seven (07) days before the subscription period ends in order for Us to process the
                    cancellation/downgrade in the next subscription cycle. In case the Developer fails to inform us
                    seven (07) days before the subscription period ends, we shall be able to process the
                    cancellation/downgrade only in the cycle after the next cycle.
                  </p>
                  <p class="paragraph c56">
                    ...
                    during the Term of this Agreement. Such adjustments will become binding after We inform the
                    Developer about the upcoming changes with a reasonable notice period of at least
                    fourteen (14) days and the Developer continues or starts using the respective Service without
                    refusing that change at least in text form to Us. In case the Developer refuses to
                    accept the changes, the existing Agreement between Us and the Developer remains unchanged, we are
                    entitled to suspend the Services immediately and to terminate the Agreement in
                    total or partly for good reason with a notice period of one (1) month. In any case we will respect
                    the Developer’s legitimate interest.
                  </p>
                  <p class="paragraph c56">
                    ...
                    www.affinidi.com/pricing, you may have to make payment of such price or any revised price updated
                    from time to time according to the rules of these Terms &amp; Conditions. You may
                    choose a mode of payment for Paid Services as offered and specified by Us at the time of the
                    subscription. You agree to pay us the applicable fees and taxes specific to Paid
                  ...
                  <p class="paragraph c56">
                    ...
                    payment processing site offering payment through various channels such as net
                    banking, debit card and credit card ("Payment Gateway") and you shall abide by the terms and
                    conditions of such Payment Gate-way.
                  </p>
                  <p class="paragraph c56">
                    ...
                    contact us section at https://www.af-finidi.com/get-in-touch and we shall respond
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <p class="paragraph c80">
                    <span class="c0">2.4.2.</span> Notwithstanding the term and termination of this Agreement (section
                    5), The Developer may send a notice to Us to terminate any of the Services at any
                  ...
                  <p class="paragraph c51">
                    <span class="c0">2.4.3.</span> We may terminate the Agreement with regard to the Developer’s
                    services fully or in parts at any time during the term of this Agreement with effect to
                  ...
                  <p class="paragraph c12">
                    ...
                    Services to Developer. If the Agreement is terminated only with respect to
                    single Services, we will cease to provide such Services. The Developer shall, within a reasonable
                    time, specifically return or destroy all copyrighted or otherwise legally
                    protected content (including CLI or software and software components) in his/her possession, and
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c102">
                    <span class="c0">2.5.1.</span> The Developer shall be responsible for meeting the system
                    requirements for the implementa-tion and use of the Services described in this Agreement.
                  </p>
                  <p class="paragraph c80">
                    <span class="c0">2.5.2.</span> The Developer shall remember his/her passphrase and keep it safe. We
                    currently do not provide any mechanisms to reset the passphrase. In this case,
                  ...
                  <p class="paragraph c12">
                    ...
                    &amp; restore option in their respective Affinidi Vault, Affinidi would be
                    storing the backup on their behalf. While creating the back-up, Consumer/Developer would receive an
                    email with the back-up id which would have to be provided while restoring the
                    backup in the vault along with the passphrase set by the Consumer/Developer for their vault. This
                    service is available with limited capability only for the web app and mobile app
                    (android) of Affinidi Vault. The Company may provide further enhancements to the cloud backup in
                    future at their discretion. This could be free or for a price as may be decided by
                    the Company.
                  </p>
                </div>
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c102">
                    <span class="c0">2.7.1.</span> We reserve the right to change our Services (in completely or in
                    part) at any time with effect for the future if this becomes necessary for good
                    reasons, neither Consumer nor the Developer is placed in a significantly worse position by the
                    change and the change is reasonable for the Consumer and the Developer. Good reasons
                    include, for example, changes to the services of our own contractual partners and the adaptation of
                    our Services to technical innovations. Rea-sonable reasons include, in
                    particular, changes that do not significantly affect the interests of Consumer or the Developer or
                    do not result in a significant restriction of the scope of use of the Services,
                  ...
                  <p class="paragraph c80">
                    ...
                    Conditions and/or the scope of Services that go beyond the cases specified under
                    section 2.7.1 e.g. by displaying such information as part of the log-in procedure for the respective
                    Services at least fourteen (14) days in advance. So far as changes beyond
                    section 2.7.1 do not affect essential contractual provisions, Developer‘s consent to the change of
                    the Agreement shall be deemed to have been granted unless the Developer objects
                    to the change in text form within fourteen (14) days after receipt of the change notification and
                    continues to using our Services.
                  </p>
                  <p class="paragraph c51">
                ...
                <p class="paragraph">
                  ...
                  received by the receiving party from a third party without a restriction on disclosure or use; or (d)
                  ...
                  notifies the disclosing party and gives the disclosing party the opportunity to seek
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c102">
                    ...
                    Developers and this Agree-ment shall be governed by the laws of the country in
                  ...
                  <p class="paragraph c12">
                    ...
                    agreements, oral or written, and all other com-munications between the parties relating to the
                    subject matter of this Agreement.
                  </p>
                  <p class="paragraph c12">
                    <span class="c0">2.9.6.</span> These Terms &amp; Conditions govern the Developers’ use of or access
                    to our Services in addition to the Privacy Notice of Affinidi.
                  </p>
                </div>
              </div>
              ...
              <div class="ms-md-5 ms-3">
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c65">
                    ...
                    Consumers enabling them to own, collect and store their data and selectively
                    share it with the Developers, and related ser-vices, in each case as set out in the respective
                    Appendix and as described in the service de-scriptions in the Appendices to the Terms
                    &amp; Conditions. The Consumer in this regard is any natural person who enters into the contract for
                    purposes that can predominantly be attributed neither to his or her commercial
                  ...
                  <p class="paragraph c74">
                    ...
                    accepting the Terms &amp; Conditions (including its Appendices), Consumer applies
                    for the agreement to the Services, which will only be concluded our acceptance of the Consumer’s
                    offer (“Agreement”). We are free to accept or deny the offer at our own discretion.
                  </p>
                  <p class="paragraph c24">
                    <span class="c0">3.1.3.</span> Any deviating terms of use expressly do not apply, even if reference
                    is made to their validity and We do not expressly object to them. Deviations
                  ...
                  <p class="paragraph c24">
                    ...
                    right to use our Services or have it used in Consumer’s interest and under
                    his/her commission to the extent granted in and for the term of the Agreement (unless explicitly
                    granted differently between Us and Consumer by citing the deviation to this section
                    3.1.4 of the Terms &amp; Conditions). The Consumer shall not reverse engineer, disassemble,
                    decompile, or use it to train any artificial intelligence model or application, except
                  ...
                  <p class="paragraph c32">
                    <span class="c0">3.1.6.</span> While taking into consideration the reasonable interest of the
                    Consumer we shall be entitled to suspend any Services fully or in part for the
                    Consumer either when an applicable quota to the Service has been reached or we have reason to
                    believe that the Consumer’s use of the Service is not compliant with these Terms &amp;
                    Conditions or negatively effects our provision of Services to other Consumers or Developers. The
                    Consumer may request to reinstate the Ser-vices when and to the extent the reason
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <div class="ms-md-5 ms-4">
                    <p class="paragraph c65" style="padding-left: 65px">
                      ...
                      store, share, and monetise their data in a fragmented data world. It also enables consumer to log
                      in to websites, applica-tions and other services that have implemented Affinidi
                      Login (as defined in section 2.2.1. of the Terms &amp; Conditions) (“Participating Platforms”)
                      using Consumer’s data stored in the Affinidi Vault after one-time registration and
                    ...
                    <p class="paragraph c74" style="padding-left: 65px">
                      <span class="c0">3.2.1.2.</span> In order to use Affinidi Vault, Consumer shall either download
                      the Affinidi Vault’s Chrome Extension from the Chrome Web Store and then login to
                      the vault or login into Affinidi Vault directly @ www.vault.affinidi.com (accessible both via
                      desktop and/or mobile). The Consumer shall then register and authenticate. As part
                      of the registration process, Consumer receives a confirmation e-mail from Us. This e-mail contains
                      a con-firmation link. By clicking on this link, Consumer confirms his/her
                      e-mail address. The purpose of submission of the registration form constitutes Consumer’s
                      declaration of offer to conclude the Agreement on the use of Affinidi Vault. We accept
                      this offer by confirming Consumer’s registration by e-mail or by activating Consumer’s access to
                      Affinidi Vault after Consumer has submitted the registration form.
                    </p>
                    <p class="paragraph c24" style="padding-left: 65px">
                      <span class="c0">3.2.1.3.</span> Affinidi Vault may also be used by way of a mobile client,
                      Affinidi Mobile App as soon as we will make it available to the consumer. The
                    ...
                    We may choose to limit the availability as well as the scope of functionalities of the Affinidi
                    Mobile App at our discretion for testing purposes. The Consumers and the De-velopers
                    ...
                    <p class="paragraph c24" style="padding-left: 65px">
                      ...
                      data provided by him/her, in particular his/her first and last name, address,
                      date of birth and e-mail ad-dress, are true and correct. The Company is not required to check or
                      authenticate the data included under the vault. Consumer’s data is exclusively
                      for Consumer‘s personal use and shall therefore be kept secret and secure at all times. The
                      Consumer shall inform Us immediately if he/she becomes aware of or suspect any
                    ...
                    <p class="paragraph c7" style="padding-left: 65px">
                      ...
                      responsible for the misuse of the data. In particular, Consumer is responsible
                      for the misuse if he/she has made the unauthorised use of the access data possible, even if only
                      negligently. If the reasons for blocking access to Consumer cease to apply, We
                  ...
                  <div class="ms-md-5 ms-4">
                    <p class="paragraph c65" style="padding-left: 65px">
                      ...
                      Agreement, the following applies: Affinidi Desktop App is an additional security
                      tool for the use of Affinidi Vault. Affinidi Desktop App enables Consumer to open Affinidi Vault
                      in Consumer’s browser, so that Affinidi Vault can only share Consumer’s data with
                      ...
                      for the use of Affinidi Vault, it is only an add-on. A Service description as well as the
                      technical system require-ments for using Affinidi Desktop App are set out in Appendix 4.
                    </p>
                    <p class="paragraph c65" style="padding-left: 65px">
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <p class="paragraph c74">
                    <span class="c0">3.4.2.</span> Notwithstanding the term and termination of this Agreement (section
                    5), the Consumer may send a notice to Us to terminate the Service at any time,
                    whether in respect of all or only selected Services, and We will execute the request of the Consumer
                    to terminate the subscrip-tions within a period of thirty (30) days of receipt
                    of the request.
                  </p>
                  <p class="paragraph c24">
                    <span class="c0">3.4.3.</span> The right of Affinidi to terminate the Services for Consumers for
                    ...
                    privacy friendly design structure followed for provi-sion of Services, there is
                    no effective method available to inform the Consumers regarding the closure of the Services in
                    advance. However, Affinidi shall ensure to share communication regarding any other
                    critical information regarding the services on their website Affinidi.com as may be feasible.
                  </p>
                  <p class="paragraph c24"><span class="c0">3.4.4.</span> Upon expiry or termination of the Agreement,
                    we will cease to provide the Services to Consumer.</p>
                  <p class="paragraph c7">
                    <span class="c0">3.4.5.</span> Without prejudice to the options to terminate the Agreement mentioned
                    above, we may cease to provide our Services in completely or in part at any
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c65">
                    <span class="c0">3.7.1.</span> We reserve the right to change our Services (completely or in part)
                    at any time with effect for the future if this becomes necessary for good
                    reasons, Consumer is not placed in a significantly worse position by the change and the change is
                    reasonable for Consumer. Good reasons in-clude, for example, changes to the
                    services of our own contractual partners and the adaptation of our Services to technical
                    innovations. Reasonable reasons include, in particular, changes that do not significantly
                    affect the interests of Consumer or do not result in a significant re-striction of the scope of use
                    of the Services, e.g., the addition of additional functions or Services.
                  </p>
                  <p class="paragraph c74">
                  ...
                  <p class="paragraph c24"><span class="c0">3.7.3.</span> If Consumer objects, either party shall have
                    the right to terminate the Agreement by giving notice with immediate effect.</p>
                  <p class="paragraph c24">
                ...
                <p class="paragraph sbold"><span class="c0">3.8.</span> Additional Provisions with regard to Services
                  for Consumers</p>
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c65">
                  ...
                  <p class="paragraph c74"><span class="c0">3.8.2.</span> With regard to the place of jurisdiction, the
                    provisions of the applicable law shall apply.</p>
                  <p class="paragraph c24"><span class="c0">3.8.3.</span> These Terms &amp; Conditions govern your use
                    of or access to our Services in addition to the Privacy Notice of Affinidi.</p>
                </div>
              </div>
              <p class="paragraph sbold"><span class="c10">4.</span> Force Majeure</p>
              <p class="paragraph">
                We are not liable for any loss, damage or penalty resulting from delays or failures in performance if
                the delay or failure results from events beyond our reasonable control (a “Force
                Majeure Event”). Force Majeure Events shall include, but are not limited to, acts of God, war,
                hostility, invasion, act of foreign enemies, rebellion, revolution, riots, civil war,
                ...
                pandemics, outbreaks, embargoes, breakdown of equipment, plant or machinery
                (including, but not lim-ited to, data centre, telecommunications systems and utility services) or other
                catastrophe.
              </p>
              ...
              <div class="ms-md-5 ms-3">
                <p class="paragraph c23">
                  ...
                  respect of all or only selected Services, and the Company shall execute the request of the Developer
                  or Consumer to terminate the Services within a period of thirty (30) days of
                ...
                <p class="paragraph c93">
                  ...
                  good cause shall remain unaffected. Good cause entitling Us to terminate the
                  Agreement exists in particular if the Developer infringes our rights of use by using our Services
                  beyond the scope permitted under this Agreement and does not cease the infringement
                ...
                <p class="paragraph c46">
                  ...
                  specifically return or destroy all copy-righted or otherwise legally protected
                  content (including CLI or software and software components) in his/her possession, and each party
                  shall return all copies of the other party's confidential information.
                </p>
              </div>
              <p class="paragraph c26 sbold"><span class="c10">6.</span> Warranty and Liability</p>
              <p class="paragraph sbold">The following rules in section 6.1 to section 6.5.7 shall apply to all
                Consumers and Developers in any global jurisdiction:</p>
              <div class="ms-md-5 ms-3">
                ...
                <p class="paragraph c115">
                  ...
                  Conditions in order to use our Services and, in particular, to register or login on a respective
                  Website or platform.
                </p>
                <p class="paragraph c75">
                  <span class="c0">6.4.</span> Without prejudice to the provisions of section 6.1, We shall not be
                  liable for the loss of Consumer’s or Developer’s data if this loss is due to
                  Consumer’s or Developer's failure to back up data in ac-cordance with section 2.5.5 and thereby ensure
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <p class="paragraph c67"><span class="c0">6.5.2.</span> regarding the availability or appropriateness
                    of the Services.</p>
              ...
              <p class="paragraph sbold">The following rules in section 6.6 shall only be applicable to Consumers and
                the Developer residing in Germany:</p>
              <div class="ms-md-5 ms-3">
                <p class="paragraph c106">
                  <span class="c0">6.6.</span> Notwithstanding anything contained herein, with respect to the
                  Developers/Consumers in Germany, apart from warranties specified under sections 6.1, 6.2
                  and 6.3 We are liable without limitation for intent or gross negligence, for injury to life, limb or
                  health, in accordance with the provisions of the German Product Liability Act and
                  to the extent of a guarantee assumed by Us. In the event of a slightly negligent breach of an
                  obligation that is essential for achieving the purpose of the Agreement (cardinal
              ...
              <p class="paragraph sbold">
                ...
                section 6.1 to section 6.6) to Consumer and the Developer who are not subject to
              ...
              <div class="ms-md-5 ms-3">
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <p class="paragraph c67"><span class="c0">6.7.2.</span> any liability, loss or damage that you may
                    incur through use of the Services; and</p>
                  <p class="paragraph c33"><span class="c0">6.7.3.</span> all decisions or actions resulting from your
                    use of the Services and the contents of the Services.</p>
                </div>
                <p class="paragraph c106">
                  <span class="c0">6.8.</span> To the maximum extent permitted by applicable law, we shall not be
                  liable, in any circumstances or legal theories whatsoever, for any damage or loss of
                  any kind, any consequential, incidental, special or indirect damages of any character, loss of data,
                  loss of business, loss of profits or goodwill, inter-ruption of business, costs,
                ...
                <p class="paragraph c106">
                  <span class="c0">6.9.</span> In the event that we are found liable to you for any reason, our
                  liability to you shall not, for any reason, exceed S$1000 (Singapore Dollars one
                  thousand only). This limitation in this Clause applies to all causes of action in the aggregate
                  including, without limitation, breach of contract, breach of warranty, negligence,
                  strict liability, misrepresentations and other torts. In any jurisdiction in which these limitations
                  of liability are restricted, our liability is limited to the greatest extent
                  permitted by law.
                </p>
              </div>
              <p class="paragraph c100 sbold"><span class="c10">7.</span> Indemnity (not applicable to
                Consumer/Developer in Germany)</p>
              <div class="ms-md-5 ms-3">
                <p class="paragraph c99">
                  <span class="c0">7.1.</span> To the fullest extent permitted under law, you agree to indemnify us, our
                  parents, subsidiaries, affil-iates, directors, officers, shareholders,
                  employees, agents, sub-contractors and licensors (collectively the “Indemnified Persons”) in respect
                  of any and all claims, losses, damages, expenses (including legal costs on a full
                  indemnity basis), or liabilities (whether criminal or civil) and costs of settlement suffered or
                  incurred by the Indemnified Persons or asserted against them in respect of:
                </p>
                <div class="ms-md-5 ms-4">
                  ...
                  <p class="paragraph c67">
                    ...
                    use of the Services that infringes any intellectual property right of any
                  ...
                  <p class="paragraph c59">
                    <span class="c0">7.1.7.</span> the occurrence of any event due to your act, omission or default
                    which comprises the security or integrity of the Services or its contents; and/or;
                  </p>
                  <p class="paragraph c2">
                    <span class="c0">7.1.8.</span> your violation of any applicable law or the rights (including but
                    without limitation to intellec-tual property rights and privacy rights) of any
              ...
              <div class="ms-md-5 ms-3">
                ...
                <p class="paragraph c52">
                  <span class="c0">8.2.</span> Parties submit to the non-exclusive jurisdiction of the courts of
                  Singapore in relation to all disputes and any claim relating to use of the Services or
              ...
              <div class="ms-md-5 ms-3">
                <p class="paragraph c17"><span class="c0">9.1.</span> By accessing and using the Services, you
                  represent, undertake and warrant that:</p>
                <div class="ms-md-5 ms-4">
                  <p class="paragraph c97"><span class="c0">9.1.1.</span> you have full capacity and authority to (and
                    do) accept and agree to the Terms &amp; Conditions;</p>
                  ...
                  <p class="paragraph c59"><span class="c0">9.1.4.</span> you will comply with all applicable security
                    or encryption standards, rules, procedures and guidelines.</p>
                </div>
              </div>
              <p class="paragraph">
              ...
              <p>
                ...
                de-centralised identity controlled by Consumers. With Affinidi Login,
                Developers are no longer burdened with collecting user information during registration. Instead, the
                Consumer’s first sign-in doubles as their registra-tion, and all the necessary data
                for onboarding can be requested during this streamlined sign- in/signup process. The data obtained
                through Affinidi Login is verifiable, eliminating the need for traditional measures
                like 'for-got password' or 'validate your email address' or 'validate your phone.' For Consumers,
                Affinidi Login gives full control, ensuring that they consent to the information
                shared in a transparent and user-friendly manner. This streamlined approach empowers Developers to
                create efficient user experiences with data integrity, en-hances security and privacy
                and ensures compatibility with industry standards, such as OID4VP (Open ID for Verifiable Presentations)
                which ensures the verification of user authenticity without the need for direct
              ...
              <p>
                Affinidi Login can be integrated with applications that support OIDC (OpenID Connect) standard which is
                an interoperable authentication protocol based on the OAuth 2.0 framework of
              ...
              <p>
                ...
                hence certain limitations may apply to those Consumers depending on their
                browsers, device or operating system (see System Requirements for Affinidi Vault). In order to use
                Affinidi Login, also Developers need Affinidi Vault.
              </p>
              <br />
              <br />
              <br />
              <p class="text-center"><strong>Appendix 2</strong></p>
              <p class="text-center"><strong>Service Description and System Requirements for Affinidi Portal</strong>
              </p>
              <p class="paragraph sbold"><span class="c0">1.</span> Service Description</p>
              <div class="ms-md-5 ms-3">
                <p class="paragraph">
                  ...
                  accessing, configuring, and tracking various Affinidi offerings. This portal simplifies the
                  integration process, allowing developers to harness the full po-tential of Affinidi
                  Services
                </p>
                <p class="paragraph">
                ...
                <p class="paragraph">
                  ...
                  Login, which requires them to share their email address from their Affinidi
                  Vault. The unique User Decentralized Identifier (DID), created during the Affinidi Vault setup, serves
                  as the Developer's identifier within the portal. Prior to accessing the portal,
              ...
              <div class="ms-md-5 ms-3">
                ...
                <p class="paragraph">
                  ...
                  to the Affinidi ecosystem. On the first login, a default project will be
                  created for the Developer. The Developer is required to share their email address from the Affinidi
                  Vault. A User DID is generated during the Affinidi Vault creation and serves as
                  the Developer's identifier. If the Developer has not set up the Affinidi Vault, they will be guided
                  through the Affinidi Vault setup process.
                </p>
              </div>
              <p class="paragraph sbold"><span class="c0">2.</span> System Requirements</p>
              <div class="ms-md-5 ms-3">
              ...
              <div class="ms-md-5 ms-3">
                <p class="paragraph">
                  ...
                  allowing them to own, collect, store and share their data in a manner that aligns
                  with their preferences and values. By using Affinidi Vault, Consumers can securely manage their
                  personal data, benefit from passwordless au-thentication, have the choice of storing
                  their data based on their preferences and share data in a pri-vacy-enabled and consent-driven manner.
                </p>
                <p class="paragraph">
                  <span class="c0">b)</span> Affinidi Vault enhances the sign-in and sign-up process. There is no longer
                  a need to collect infor-mation during registration. The Consumer’s first
                  sign-in serves as registration, and onboarding data can be requested then. All data obtained through
                  is verifiable, eliminating the need for cumbersome validation. Regarding
                  Privacy-Enabled Data Sharing, Affinidi Vault leverages decentralised technol-ogies, such as verifiable
                  credentials, to enable privacy-enabled data sharing. During the Affinidi Vault
                  setup, a unique User Decentralized Identifier (DID) is created that serves as the Consumer’s
                  identifier.
                </p>
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph">
                    ...
                    www.vault.affinidi.com , through either desktop/mobile web app or b) by downloading the
                    corresponding Chrome Extension from the Chrome Web Store and then logging into the vault ;and in
                    both cases secure Affinidi Vault with a passphrase.
                  </p>
                  <p class="paragraph">
                    <span class="c0">ii.</span> In case the Developer/Consumer is using the Chrome extension the vault
                    can also be secured with biometrics. (The biometric unlocking method is an
                    effective way to secure the Affinidi Vault and the data stored therein while being convenient and
                    fast for the Consumer, improving their experience and eliminating the need to
                    manually entering their passphrase every time their Affinidi Vault is locked).
                  </p>
                  <p class="paragraph"><span class="c0">iii.</span> Access the profile page and fill, modify or delete
                    the profile data</p>
                  ...
                  <p class="paragraph">
                    ...
                    app(Android), the user is also provided an option to back up and restore their data from
                    the cloud wherein the user can upload a backup of his vault into the cloud and then restore it with
                    a backup ID and his current pass-phrase
                  </p>
                </div>
                <p class="paragraph"><span class="c0">d)</span> With regards to the cloud backup:</p>
                <div class="ms-md-5 ms-4">
                  <p class="paragraph"><span class="c0">i.</span> The user can select the option from the settings menu
                    in the vault</p>
                  <p class="paragraph">
                    <span class="c0">ii.</span> Once the user selects the option to back up their vault on the cloud,
                    the user is required to use their passphrase to initiate the process
                  </p>
                  <p class="paragraph">
                ...
                <div class="ms-md-5 ms-4">
                  ...
                  <p class="paragraph">
                    <span class="c0">ii.</span> During the liveness check, the user receives a prompt instructing them
                    to show their face to the camera. The application analyses the data to determine
                    whether the user face is consistent with live behaviour. This may involve assessing movement,
                    changes in facial features, or other dy-namic elements
                  </p>
                ...
                <p class="paragraph"><span class="c0">g)</span> Any other new feature that may be introduced by us to
                  the users of the vault</p>
              </div>
              <p class="paragraph sbold"><span class="c0">2.</span> System Requirements</p>
              <div class="ms-md-5 ms-3">
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph">
                    ...
                    use or pair Desktop App in case biometrics and account password are not set on
                    the system of the user.
                  </p>
                </div>
                <p class="paragraph"><span class="c0">c)</span> For Wep App</p>
                <div class="ms-md-5 ms-4">
                  <p class="paragraph"><span class="c0">i.</span> For the best experience we recommend using Google
                    Chrome browser</p>
              ...
              <div class="ms-md-5 ms-3">
                <p class="paragraph">
                  ...
                  aligns with their pref-erences and values. By using the mobile app, Consumers can securely manage
                  their personal data, benefit from passwordless authentication, have the choice of
                ...
                <div class="ms-md-5 ms-4">
                  <p class="paragraph"><span class="c0">i.</span> Set up a vault and secure it with a passphrase and/or
                    biometrics</p>
                  <p class="paragraph"><span class="c0">ii.</span> Access the profile page and fill, modify or delete
                    the profile data</p>
