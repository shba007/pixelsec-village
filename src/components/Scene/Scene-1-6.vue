      ...
      <div class="container">
        <article>
          ...
          <p class="paragraph">
            ...
            or “Us”) is a com-pany in the field of information technology. One of our key services is the provision of a
            data vault called Affinidi Vault, allowing end users (“Consumer”) to own,
            ...
            We offer various services and products to the Developer as well as to Consumer, each of which is subject to
            these Terms and Conditions (“Terms &amp; Conditions”). Section 2 of the Terms
          ...
          <div class="ms-md-5 ms-3">
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c11">
                ...
                accepting the Terms &amp; Conditions (including its appendices), the Developer applies
                for the agreement to the Services, which will only be concluded by our acceptance of Developer’s offer
                (hereinafter: “Agree-ment”). We are free to accept or deny the offer at our own
                discretion.
              </p>
              <p class="paragraph c40">
                <span class="c0">2.1.3.</span> We offer our Services according to section 2 to Developers, defined as a
                natural or legal person who, at the time of concluding this Term and Conditions,
                is acting in the exercise of his/her commercial or professional activity. In case of any amendment to
                these Terms and Conditions, they shall be required to be agreed in writing between
                the Parties.
              </p>
              <p class="paragraph c78">
                <span class="c0">2.1.4.</span> Insofar as the Services include the provision of copyrighted or otherwise
                (e.g. as trade secret) legally protected content (e.g. software, software
                components, CLIs), We grant the Developer a worldwide, non-exclusive, non-transferable and non-sub
                licensable right to use the content or have it used in Developer’s interest and under
                its commission to the extent granted in and for the term of the Agreement (unless explicitly granted
                differently between Us and the Devel-oper by citing the deviation to this section
                2.1.4 of the Terms &amp; Conditions). The Developer shall not transfer the content to third parties in
                particular, he/she shall not sell, lend, rent or publicly reproduce the content
                or make it accessible. The Developer shall not reverse engi-neer, disassemble, decompile, except to the
                extent permitted by applicable mandatory law, or use it to train any artificial
                intelligence model or application.
              </p>
              <p class="paragraph c111">
                <span class="c0">2.1.5.</span> Insofar as our Services contain open-source software (“OSS”) components,
                the use of these components is exclusively subject to the corresponding terms
                and conditions of the respective OSS. No provision of the Terms &amp; Conditions shall affect the rights
                or obligations of the De-veloper under the corresponding terms and conditions
              ...
              <p class="paragraph c20">
                ...
                conflicts or ambiguities between any provision of this Terms &amp; Conditions and the Appendices hereto,
                the terms in this Terms &amp; Conditions shall take precedence and prevail over
                the terms of the Appendices, unless and to the extent: (a) If it is explicitly stated otherwise in this
                Terms &amp; Conditions and/or the Appen-dix, or (b) an Appendix explicitly
            ...
            <p class="paragraph c6">
              ...
              products and deliverables that the Developer has applied for by way of our order
              process and that has been made part of the Agreement upon our acceptance and which may include but not be
            ...
            <div class="ms-md-5 ms-4">
              ...
              <div class="ms-md-5 ms-4">
                <p class="paragraph" style="padding-left: 65px">
                  ...
                  from Con-sumer while Consumer is logging in or registering on Developer's website
                  or app. A service description as well as the technical system requirements for using Affinidi Login
              ...
              <div class="ms-md-5 ms-4">
                <p class="paragraph" style="padding-left: 65px">
                  ...
                  implement our Services or parts thereof on his/her app or service. A service description
                  as well as the technical system requirements for using CLI are set out in Appendix 3.
                </p>
                <p class="paragraph" style="padding-left: 65px">
                  <span class="c0">2.2.3.2.</span> As CLI provided by Us is not necessarily required to be installed in
                  order to implement our Services or parts thereof, the Developer may also use a
                  ...
                  the terms and conditions of the respective provider shall apply in this regard. We
                  shall not be responsible for and do not warrant that our Services are usable with any particular third
                  party CLI or soft-ware component or software-like tools. We reserve the right
                  to reject or exclude third party CLI providers if this becomes necessary for weighty reasons . Weighty
                  reasons are, for example, a technical incompatibility of the service of the
                  third-party provider with our Services, legal reasons that prevent the connection to our Services or
                  the adap-tation of our Services to technical innovations.
                </p>
              </div>
              ...
              <p class="paragraph">
                ...
                the Developer can test our Services and their functionalities in parallel to the live oper-ation of our
                Services. In order to be able to use Reference App, the Developer needs Affinidi
                Vault. In this regard, sections 2.2.1 and 2.2.1.1 applies accordingly. Reference App runs sepa-rately
                from the live operation of our Services. In particular, this means that Reference
                App is not connected to Consumer's Affinidi Vault in the sense that Consumer data is transferred from
                Affinidi Vault to Reference App. The Developer shall not feed any real data from
                Consumers into Reference App and would be solely liable to the Consumer in case they are adding such
                information on the Reference App.
              </p>
              <p class="paragraph c40"><span class="c0">2.2.5.</span> Affinidi Desktop App</p>
              <p class="paragraph">
                To the extent Affinidi Desktop App has been made part of the Agreement, the following ap-plies: Affinidi
                Desktop App is an additional security tool for the use of Affinidi Vault.
                Affinidi Desktop App enables Consumer to open Affinidi Vault in Consumer’s browser, so that Affinidi
                Vault can only share Consumer’s data with the Developer if Consumer has previously
                un-locked Affinidi Vault in his/her browser by entering his/her biometric data. The use of Affinidi
                Desktop App is not required for the use of Affinidi Vault, it is only an add-on. A
                service de-scription as well as the technical system requirements for using Affinidi Desktop App are set
                out in Appendix 5.
              </p>
              <p class="paragraph c40"><span class="c0">2.2.6.</span> Support</p>
              <p class="paragraph">
                We offer support services (“Support”) for the implementation and use of our Services to the extent this
                has been made part of the Agreement. Unless otherwise agreed, our Support is
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c56">
                <span class="c0">2.3.2.</span> The subscription tiers may as well be subject to limitations with respect
                to Monthly Active Users (“MAUs”), Affinidi Credits, Customer Support, etc. as
                specified in the Developer Portal and/or www.affinidi.com/pricing (“Pricing Page”). When the Developer’s
                actual usage of the Services reaches the limits or nears the limits as
                specified under the various subscription tiers in the Developer Portal and/or the Pricing Page, we may
                notify the Developer accordingly and suggest an upgrade of his subscription tier;
                at our discretion but taking into account the Devel-oper’s interest we may also block any further
                actions within the Services that would exceed the defined quota. Affinidi can at their
                discretion charge overage for exceeding the MAUs or any other limitation as more particularly specified
                under the Developer Portal and/or the Pric-ing Page. The Developer will not be
                able to complete any further API call when the number of Credits in that Developer’s account at the
                moment of request to the API call does not cover the actually defined Credit cost.
                Further, the Developer may not be able to add users to their services through Affinidi Services, in case
                they reach their maximum MAU limit. For the pur-pose of this clause,
              </p>
              <div class="ms-md-5 ms-4">
                <p class="paragraph" style="padding-left: 65px">
                  <span class="c0">2.3.2.1.</span> Affinidi Credits (“Credit(s)”) refers to credits provided by Affinidi
                  as a fair play mech-anism to the account of the Developer. Each subscription
              ...
              <p class="paragraph c56">
                ...
                next subscription cycle. In case the Developer fails to inform us seven (07) days
                before the subscription period ends, we shall be able to process the cancellation/downgrade only in the
              ...
              <p class="paragraph c56">
                <span class="c0">2.3.5.</span> In case you have subscribed to or interested in any of the paid services
                introduced by Us (“Paid Services”) and as specified at www.affinidi.com/pricing,
                you may have to make payment of such price or any revised price updated from time to time according to
                the rules of these Terms &amp; Conditions. You may choose a mode of payment for
                Paid Services as offered and specified by Us at the time of the subscription. You agree to pay us the
                applicable fees and taxes specific to Paid Services as required under applicable
                laws for the time being in force.
              </p>
              <p class="paragraph c56">
                <span class="c0">2.3.6.</span> You may also be redirected for payment purposes to a third-party payment
                processing site offering payment through various channels such as net banking,
                debit card and credit card ("Payment Gateway") and you shall abide by the terms and conditions of such
                Payment Gate-way.
              </p>
              <p class="paragraph c56">
                <span class="c0">2.3.7.</span> In case of any disputes with respect to any payments made to us under the
                subscription plans or any other manner for availing the Services, the
                Developers can contact us through either the contact us section in Affinidi Portal or though the contact
                us section at https://www.af-finidi.com/get-in-touch and we shall respond to
                the queries without undue delay.
              </p>
            </div>
            <p class="paragraph sbold"><span class="c0">2.4.</span> Term and Termination of the Services for Developers
            </p>
            <div class="ms-md-5 ms-4">
              <p class="paragraph c102"><span class="c0">2.4.1.</span> The term of the subscription tiers as well as the
                subscription to any of our services shall be unlimited.</p>
              <p class="paragraph c80">
                ...
                time, whether in respect of all or only selected Services or subscription tiers, and We will execute the
                request of the Developer to terminate the subscriptions within a period of
              ...
              <p class="paragraph c51">
                ...
                fully or in parts at any time during the term of this Agreement with effect to the
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c51">
                <span class="c0">2.5.3.</span> The Developer shall be responsible for providing the facilities including
                hardware, software and internet connection necessary to properly use the
                Services as set out in the Agreement and which are within his/her sphere. The Developer shall be
                responsible that the Services ordered are fit for his/her purpose and he/she has asked
                for all relevant information. The Developer shall further be responsible for the security of his/her
                systems in place to use our Services and for protecting them against malicious
                software and attacks.
              </p>
              <p class="paragraph c12">
                <span class="c0">2.5.4.</span> Insofar as our Services contain components of software for which separate
                license conditions apply and are to be observed, We shall draw Developer's
                ...
                open-source license terms shall prevail over the terms of this Agreement. The Developer shall be solely
                responsible to comply with the open-source license conditions in accordance with
              ...
              <p class="paragraph c114">
                ...
                Developer is responsible for the backup and storage of any data transferred to Us by
                either the Developer or Consumer using our Services via Developer’s website. We can rely on the
                assumption that any data We will come in contact with or have influence on by way or in
                connection to our Services, has been saved for backup purposes by the Developer on a state-of-the-art
                level.
              </p>
              <p class="paragraph c12">
                ...
                the back-up id which would have to be provided while restoring the backup in the
                vault along with the passphrase set by the Consumer/Developer for their vault. This service is available
                with limited capability only for the web app and mobile app (android) of
            ...
            <p class="paragraph c28">
              ...
              controller. This applies in particular to the extent that the Developer processes personal
              data of the Consumer previously provided to him/her by the Consumer in the context of their contractual or
              pre-contractual relationship. The Developer indemnifies us against any claims
              made against us by the Consumer based on Developer‘s unlawful processing of Consumer‘s personal data
              received from the Consumer. Apart from that, We are compliant with applicable laws,
              in particular the General Data Protection Regulation (GDPR), Singaporean Data Protection Regulations and
              Indian Data Pro-tection Regulations.
            </p>
            <p class="paragraph sbold"><span class="c0">2.7.</span>Modification of Services or of the Terms &amp;
              Conditions</p>
            <div class="ms-md-5 ms-4">
              <p class="paragraph c102">
                <span class="c0">2.7.1.</span> We reserve the right to change our Services (in completely or in part) at
                any time with effect for the future if this becomes necessary for good reasons,
                neither Consumer nor the Developer is placed in a significantly worse position by the change and the
                change is reasonable for the Consumer and the Developer. Good reasons include, for
                example, changes to the services of our own contractual partners and the adaptation of our Services to
                technical innovations. Rea-sonable reasons include, in particular, changes that
                do not significantly affect the interests of Consumer or the Developer or do not result in a significant
                restriction of the scope of use of the Services, e.g., the addition of
                additional functions or Services
              </p>
              <p class="paragraph c80">
                <span class="c0">2.7.2.</span> We will inform the Developer of any changes to the Terms &amp; Conditions
                and/or the scope of Services that go beyond the cases specified under section
                2.7.1 e.g. by displaying such information as part of the log-in procedure for the respective Services at
                least fourteen (14) days in advance. Insofar as changes beyond section 2.7.1 do
                not affect essential contractual provisions, Developer‘s consent to the change of the Agreement shall be
                deemed to have been granted unless the Developer objects to the change in text
                form within fourteen (14) days after receipt of the change notification and continues to using our
                Services.
              </p>
              <p class="paragraph c51">
                <span class="c0">2.7.3.</span> If the Developer objects, we are entitled to suspend the Developer’s
                access to the particular Service and we may terminate the Agreement extraordinarily
                with immediate effect or rea-sonable notice period. In any case we will take into account the reasonable
                interest of the Developer.
              </p>
              <p class="paragraph c12">
                <span class="c0">2.7.4.</span> Furthermore, We reserve the right to make changes to the Terms &amp;
                Conditions insofar as these are necessary to fill regulatory gaps or serve to
            ...
            <p class="paragraph">
              ...
              efforts to maintain the confidentiality of the other party’s confidential information
              as it uses to pro-tect its own confidential information of a similar nature, but in any event no less than
              reasonable efforts. Neither party shall disclose such confidential information
              to third parties nor use the other party’s confidential information for any purpose other than the
              purposes of this Agreement. Confi-dential information does not include information
              that: (a) is already known by the receiving party at time of disclosure; (b) becomes, through no act or
              fault of the receiving party, publicly known; (c) is received by the receiving
              party from a third party without a restriction on disclosure or use; or (d) is independently developed by
              the receiving party without reference to confidential information of the
              disclosing party. A party may disclose confidential information of the other party to the extent required
              to be disclosed by a court or governmental agency pursuant to a statute,
              regulation or valid order; provided that the receiving party first notifies the disclosing party and gives
              the disclosing party the opportunity to seek a protective order or to contest
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c80">
                ...
                Developers and this Agree-ment shall be finally settled under the Rules of Arbitration
                of the International Chamber of Commerce (ICC) by one or more arbitrators appointed in accordance with
                such Rules.
              </p>
              ...
              <p class="paragraph c12">
                ...
                invalid, void, illegal or oth-erwise unenforceable under any law or by any court or in
                any other proceeding, shall be amended to the extent required to render it valid, legal and enforceable,
                or deleted if no such amendment is feasible, and such amendment or deletion
              ...
              <p class="paragraph c12">
                ...
                statement of the agreement between the parties, which supersedes all prior agreements,
                oral or written, and all other com-munications between the parties relating to the subject matter of
                this Agreement.
              </p>
              <p class="paragraph c12">
          ...
          <div class="ms-md-5 ms-3">
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph c65">
                ...
                it with the Developers, and related ser-vices, in each case as set out in the respective Appendix and as
                described in the service de-scriptions in the Appendices to the Terms &amp;
                Conditions. The Consumer in this regard is any natural person who enters into the contract for purposes
                that can predominantly be attributed neither to his or her commercial nor to his
              ...
              <p class="paragraph c24">
                <span class="c0">3.1.4.</span> Insofar as the Services include the provision of copyrighted or otherwise
                (e.g. as trade secret) legally protected content (e.g., software, software
                components), We grant Consumer a world-wide, non-exclusive, non-transferable and non-sublicensable right
                to use our Services or have it used in Consumer’s interest and under his/her
                ...
                the Terms &amp; Conditions). The Consumer shall not reverse engineer, disassemble, decompile, or use it
                to train any artificial intelligence model or application, except to the extent
                permitted by applicable mandatory law.
              </p>
              <p class="paragraph c7"><span class="c0">3.1.5.</span> The use of our Services shall only be allowed when
                Consumer is at least 18 years old.</p>
            ...
            <p class="paragraph">
              ...
              products and deliverables that Consumer has applied for by way of our order process
              and that has been made part of the Agreement upon our acceptance and which may include(but not be
            ...
            <div class="ms-md-5 ms-4">
              ...
              <div class="ms-md-5 ms-4">
                <p class="paragraph c65" style="padding-left: 65px">
                  <span class="c0">3.2.1.1.</span> To the extent Affinidi Vault has been made part of the Agreement, the
                  following applies: Affinidi Vault enables Consumer to discover, collect, store,
                  share, and monetise their data in a fragmented data world. It also enables consumer to log in to
                  websites, applica-tions and other services that have implemented Affinidi Login (as
                  defined in section 2.2.1. of the Terms &amp; Conditions) (“Participating Platforms”) using Consumer’s
                  data stored in the Affinidi Vault after one-time registration and
                  ...
                  Participating Platforms. A service description as well as the technical system requirements for using
                  Affinidi Vault are set out in Appendix 4.
                </p>
                <p class="paragraph c74" style="padding-left: 65px">
                  ...
                  Affinidi Vault’s Chrome Extension from the Chrome Web Store and then login to the
                  vault or login into Affinidi Vault directly @ www.vault.affinidi.com (accessible both via desktop
                  and/or mobile). The Consumer shall then register and authenticate. As part of the
                  registration process, Consumer receives a confirmation e-mail from Us. This e-mail contains a
                  con-firmation link. By clicking on this link, Consumer confirms his/her e-mail address.
                  The purpose of submission of the registration form constitutes Consumer’s declaration of offer to
                  conclude the Agreement on the use of Affinidi Vault. We accept this offer by
                  confirming Consumer’s registration by e-mail or by activating Consumer’s access to Affinidi Vault
                ...
                App at our discretion for testing purposes. The Consumers and the De-velopers who
                we will make it available to will be informed about the respective limitations.
                <p></p>
                <p class="paragraph c24" style="padding-left: 65px">
                  <span class="c0">3.2.1.4.</span> Affinidi Vault allows/may allow Consumer to discover, collect, store,
                  share, and mone-tise their data manage his/her data centrally. In this way,
                  Consumer can, for example, add to, correct and change his/her data. The Consumer assures that the data
                  provided by him/her, in particular his/her first and last name, address, date
                  ...
                  Consumer‘s personal use and shall therefore be kept secret and secure at all times. The Consumer shall
                  inform Us immediately if he/she becomes aware of or suspect any unauthorised
              ...
              <div class="ms-md-5 ms-4">
                <p class="paragraph c65" style="padding-left: 65px">
                  ...
                  entering his/her biometric data. The use of Affinidi Desktop App is not required for
                  the use of Affinidi Vault, it is only an add-on. A Service description as well as the technical system
                  require-ments for using Affinidi Desktop App are set out in Appendix 4.
                </p>
                <p class="paragraph c65" style="padding-left: 65px">
                  <span class="c0">3.2.2.2.</span> Section 3.2.1.5 of the Terms &amp; Conditions apply accordingly also
                  to the use of Affinidi Desktop App.
                </p>
              </div>
            </div>
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c74">
                ...
                whether in respect of all or only selected Services, and We will execute the request of the Consumer to
                terminate the subscrip-tions within a period of thirty (30) days of receipt of
                the request.
              </p>
              <p class="paragraph c24">
                <span class="c0">3.4.3.</span> The right of Affinidi to terminate the Services for Consumers for good
                cause shall remain unaffected. Good cause entitling Us to terminate the Agreement
                exists in particular if Con-sumer has provided false and/or incomplete data during registration and/or
                has not updated his/her registration data in the event of a subsequent change
                and/or has disclosed his/her access data without authorisation and does not cease such infringement
                within a reasonable period after warning by Us. Considering Affinidi Is not storing
                any of the communication details of the Consumers and also considering the privacy friendly design
                structure followed for provi-sion of Services, there is no effective method available
                to inform the Consumers regarding the closure of the Services in advance. However, Affinidi shall ensure
                to share communication regarding any other critical information regarding the
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph c65">
                <span class="c0">3.5.1.</span> Consumer shall be responsible for meeting the system requirements for the
                implementation and use of the Services described in this Agreement.
              </p>
              <p class="paragraph c74">
                <span class="c0">3.5.2.</span> Consumer shall remember his/her passphrase and keep it safe. We currently
                do not provide any mechanisms to reset the passphrase. In this case, Consumer
                must re-register and re-authenticate.
              </p>
            </div>
            <p class="paragraph sbold"><span class="c0">3.6.</span> Data Protection</p>
            <p class="paragraph">
              We are compliant with applicable data privacy laws, in particular the latest regulation in European Union
              law on Data Protection and Data Privacy, General Data Protection Regulation
              ...
              Platforms and by Developers respectively. In this regard, Consumer shall contact Developer. For the rest,
              We refer to our Privacy Notice
            </p>
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph c65">
                ...
                any time with effect for the future if this becomes necessary for good reasons,
                Consumer is not placed in a significantly worse position by the change and the change is reasonable for
                Consumer. Good reasons in-clude, for example, changes to the services of our own
                contractual partners and the adaptation of our Services to technical innovations. Reasonable reasons
                include, in particular, changes that do not significantly affect the interests of
                Consumer or do not result in a significant re-striction of the scope of use of the Services, e.g., the
                addition of additional functions or Services.
              </p>
              <p class="paragraph c74">
                <span class="c0">3.7.2.</span> We will inform Consumer within a reasonable period of time of any changes
                to these Terms &amp; Conditions and/or the scope of services that go beyond the
                cases specified in section 3.7.1 We undertake to expressly inform Consumer of the respective
                modifications by sending the mod-ified GTC and the consequences of not objecting to these
                modifications.
              </p>
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c74"><span class="c0">3.8.2.</span> With regard to the place of jurisdiction, the
                provisions of the applicable law shall apply.</p>
              <p class="paragraph c24"><span class="c0">3.8.3.</span> These Terms &amp; Conditions govern your use of or
                access to our Services in addition to the Privacy Notice of Affinidi.</p>
            </div>
          </div>
          ...
          <p class="paragraph">
            ...
            disturbances, requisitioning or other acts of civil or military authority, laws, regulations, acts or orders
            of any governmental authority, body, agency or official, fires, inclement
            weather, rain or floods (however caused), strikes, lock-outs or other labour disputes, epidemics, pandemics,
            outbreaks, embargoes, breakdown of equipment, plant or machinery (including,
          ...
          <div class="ms-md-5 ms-3">
            <p class="paragraph c23">
              <span class="c0">5.1.</span> Notwithstanding the foregoing, the Developer as well as the Consumer may send
              a notice to the Company to terminate the Agreement at any time, whether in
              respect of all or only selected Services, and the Company shall execute the request of the Developer or
              Consumer to terminate the Services within a period of thirty (30) days of receipt
              of the request.
            </p>
            ...
            <p class="paragraph c46">
              ...
              (including CLI or software and software components) in his/her possession, and each party shall return all
          ...
          <div class="ms-md-5 ms-3">
            <p class="paragraph c91">
              <span class="c0">6.1.</span> In case there is a reduction or discontinuation of our Services, you are not
              entitled to any warranty rights in this respect, unless We have fraudulently
              concealed a defect.
            </p>
            ...
            <p class="paragraph c75">
              ...
              or Developer's failure to back up data in ac-cordance with section 2.5.5 and thereby ensure that lost data
              can be restored with reasonable effort.
            </p>
            <p class="paragraph c106">
              <span class="c0">6.5.</span> To the maximum extent permitted by applicable law of the country of residence
              of the Consumer or Developer, we make no guarantee, representation or
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c33">
                <span class="c0">6.5.3.</span> that Services will be error-free, continuously available or uninterrupted
                in operation, un-hack-able, uncompromisable, free of any data breach
                (inadvertently or intentionally through inter-ference or interception by third parties) or free of bugs,
                computer viruses, unauthorised soft-ware, or other harmful codes or components
                not specifically mentioned herein.
              </p>
              <p class="paragraph c59">
                <span class="c0">6.5.4.</span> that the Services will not be susceptible to any cybersecurity breach or
                cannot be compromised and/or free of any data breach (inadvertently or
                intentionally through interference or interception by third parties);
              </p>
              <p class="paragraph c2"><span class="c0">6.5.5.</span> that the Services will contain information that is
                always timely and accurate;</p>
              <p class="paragraph c2"><span class="c0">6.5.6.</span> that Services will operate or function properly on
                your devices or operating systems; or;</p>
          ...
          <div class="ms-md-5 ms-3">
            <p class="paragraph c106">
              ...
              in accordance with the provisions of the German Product Liability Act and to the
              extent of a guarantee assumed by Us. In the event of a slightly negligent breach of an obligation that is
              essential for achieving the purpose of the Agreement (cardinal obligation), Our
              liability is limited to the amount of the damage that is foreseeable and typical according to the type of
              contract in question here. Apart from that, any of Our liability to-wards the
              Developers/Consumers in Germany is excluded.
            </p>
          </div>
          <p class="paragraph sbold">
            The following rules in section 6.7 to section 6.9 shall only apply (and in deviation of the rules in section
            6.1 to section 6.6) to Consumer and the Developer who are not subject to the
          ...
          <div class="ms-md-5 ms-3">
            ...
            <p class="paragraph c106">
              <span class="c0">6.8.</span> To the maximum extent permitted by applicable law, we shall not be liable, in
              any circumstances or legal theories whatsoever, for any damage or loss of any
              kind, any consequential, incidental, special or indirect damages of any character, loss of data, loss of
              business, loss of profits or goodwill, inter-ruption of business, costs, expenses
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c67">
                <span class="c0">6.8.2.</span> that you may incur as a result of your dealing with a third-party service
                provider /Con-sumer or any another user through the Services:
              </p>
              <p class="paragraph c33"><span class="c0">6.8.3.</span> resulting from the performance of the Services or
                any delay or failure thereof:</p>
            ...
            <p class="paragraph c106">
              <span class="c0">6.9.</span> In the event that we are found liable to you for any reason, our liability to
              you shall not, for any reason, exceed S$1000 (Singapore Dollars one thousand
              only). This limitation in this Clause applies to all causes of action in the aggregate including, without
              limitation, breach of contract, breach of warranty, negligence, strict
              liability, misrepresentations and other torts. In any jurisdiction in which these limitations of liability
              are restricted, our liability is limited to the greatest extent permitted by
              law.
            </p>
          </div>
          <p class="paragraph c100 sbold"><span class="c10">7.</span> Indemnity (not applicable to Consumer/Developer in
            Germany)</p>
          <div class="ms-md-5 ms-3">
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph c97"><span class="c0">7.1.1.</span> Your access, use of, or conduct in connection with
                the Services;</p>
              <p class="paragraph c67">
                <span class="c0">7.1.2.</span> any application that you develop in connection with your access to or use
                of the Services that infringes any intellectual property right of any person or
              ...
              <p class="paragraph c2">
                <span class="c0">7.1.5.</span> any content sent or received by you (as a Developer/Consumer or received
                by the Developer from the Consumers) through the Services;
              </p>
              ...
              <p class="paragraph c2">
                <span class="c0">7.1.8.</span> your violation of any applicable law or the rights (including but without
                limitation to intellec-tual property rights and privacy rights) of any other
                person or entity.
              </p>
            </div>
          ...
          <p class="paragraph sbold"><span class="c0">8.</span> Applicable Laws with respect to Developers and Consumers
            residing outside Germany</p>
          <div class="ms-md-5 ms-3">
          ...
          <div class="ms-md-5 ms-3">
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph c33">
                <span class="c0">9.1.3.</span> you will comply with all applicable laws and regulations with respect to
                your activities on and in connection with the Services; and
              </p>
          ...
          <p class="paragraph">
            <span class="c0">10.</span> You will provide all support, information and assistance necessary for us or our
            authorised representatives to conduct investigations, audits or inspections for
            the purpose of ensuring proper compliance with the Terms &amp; Conditions or our legal or regulatory
          ...
          <p class="paragraph"><strong>Appendix 2:</strong> Service description and system requirements for Affinidi
            Portal</p>
          <p class="paragraph"><strong>Appendix 3:</strong> Service description and system requirements for Affinidi CLI
          </p>
          ...
          <p>
            ...
            sign-in doubles as their registra-tion, and all the necessary data for onboarding
            can be requested during this streamlined sign- in/signup process. The data obtained through Affinidi Login
            is verifiable, eliminating the need for traditional measures like 'for-got
            password' or 'validate your email address' or 'validate your phone.' For Consumers, Affinidi Login gives
            full control, ensuring that they consent to the information shared in a transparent
            and user-friendly manner. This streamlined approach empowers Developers to create efficient user experiences
            with data integrity, en-hances security and privacy and ensures compatibility
            with industry standards, such as OID4VP (Open ID for Verifiable Presentations) which ensures the
            verification of user authenticity without the need for direct com-munication with the
          ...
          <p>
            While Affinidi may provide ready to use libraries and SDKs for specific programming languages or frame-works
            for seamless integration with Affinidi Login, it doesn’t limit the usage or
            integration of Affinidi Login within applications that are built with other programming languages, if those
            applications are compatible with OIDC standard. However, both Developers and
            Consumers will need Affinidi Vault to use Affinidi Login from any application it was integrated into, hence
            certain limitations may apply to those Consumers depending on their browsers,
          ...
          <div class="ms-md-5 ms-3">
            <p class="paragraph">
              ...
              interactions with Affinidi Services, offering a user-friendly interface for accessing,
              configuring, and tracking various Affinidi offerings. This portal simplifies the integration process,
              allowing developers to harness the full po-tential of Affinidi Services
            </p>
            <p class="paragraph">
              <span class="c0">b)</span> Developers can log in to the Affinidi ecosystem using Affinidi Login which
              requires them to share their verified email address from the Affinidi vault. On the
              first login, a default project will be created for the Developer. Under projects, Developers can configure
              different Affinidi services (Affinidi Login etc.). They will be able to
            ...
            <p class="paragraph">
              ...
              manage their accounts. With a commitment to user-friendly design and robust functionality, Affinidi Portal
              is the gateway to unlocking the full potential of Affinidi Services for
              Developers
            </p>
            <p class="paragraph">
              ...
              Developer's identifier within the portal. Prior to accessing the portal, Developers
          ...
          <div class="ms-md-5 ms-3">
            <p class="paragraph">
              <span class="c0">a)</span> Affinidi CLI is a tool designed for Developers to seamlessly access, configure,
              and track Affinidi Services through a command-line interface (CLI). Leveraging
              the Node Package Manager (NPM), Developers can easily import Affinidi CLI and kick-start their journey
              with Affinidi Services. Af-finidi CLI empowers Developers to efficiently interact
              with Affinidi Services through a simple and convenient command-line interface. Whether creating Projects,
              configuring login options, or manag-ing user groups, Affinidi CLI streamlines
              the process for Developers working with Affinidi services.
            </p>
            <p class="paragraph">
              <span class="c0">b)</span> After installation, Developers can use the Affinidi start command to log in to
              the Affinidi ecosystem. On the first login, a default project will be created
              for the Developer. The Developer is required to share their email address from the Affinidi Vault. A User
              DID is generated during the Affinidi Vault creation and serves as the
          ...
          <div class="ms-md-5 ms-3">
            <p class="paragraph">
              <span class="c0">a)</span> Affinidi Vault empowers Consumers with a “360-degree view of oneself”, allowing
              them to own, collect, store and share their data in a manner that aligns with
              their preferences and values. By using Affinidi Vault, Consumers can securely manage their personal data,
              benefit from passwordless au-thentication, have the choice of storing their data
            ...
            <p class="paragraph">
              ...
              verifiable, eliminating the need for cumbersome validation. Regarding Privacy-Enabled Data
              Sharing, Affinidi Vault leverages decentralised technol-ogies, such as verifiable credentials, to enable
              privacy-enabled data sharing. During the Affinidi Vault setup, a unique User
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph">
                <span class="c0">i.</span> Set up a vault by either a) going/being redirected to www.vault.affinidi.com
                , through either desktop/mobile web app or b) by downloading the corresponding
              ...
              <p class="paragraph">
                ...
                also be secured with biometrics. (The biometric unlocking method is an effective
                way to secure the Affinidi Vault and the data stored therein while being convenient and fast for the
                Consumer, improving their experience and eliminating the need to manually entering
              ...
              <p class="paragraph"><span class="c0">v.</span> Authenticate on a Website and share the data from his
                vault</p>
              <p class="paragraph"><span class="c0">vi.</span> Depending on the type of device the vault is created, the
                data is stored in the respective device storage</p>
              <p class="paragraph">
                <span class="c0">vii.</span> While using web app - @ www.vault.affinidi.com or the mobile app(Android),
                the user is also provided an option to back up and restore their data from the
                cloud wherein the user can upload a backup of his vault into the cloud and then restore it with a backup
                ID and his current pass-phrase
              </p>
            </div>
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph">
                <span class="c0">iii.</span> Once the process is initiated, the user would receive a “Backup-id” on this
                email specified in the vault. This would be unique id assigned to the user for
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph">
                ...
                interacting with the ap-plication, as opposed to an automated process like a bot or
                a static image
              </p>
              <p class="paragraph">
                ...
                whether the user face is consistent with live behaviour. This may involve assessing movement, changes in
                facial features, or other dy-namic elements
              </p>
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph">
                ...
                biometric unlocking method is an effective way to secure the Affinidi Vault and the data stored therein
                while being convenient and fast for the Consumer, improving their experience and
          ...
          <div class="ms-md-5 ms-3">
            ...
            <div class="ms-md-5 ms-4">
              <p class="paragraph">
                <span class="c0">i.</span> Passcode/Biometrics device protection is enabled- users won’t be able to use
                or pair Desktop App in case biometrics and account password are not set on the
                system of the user.
              </p>
            </div>
          ...
          <div class="ms-md-5 ms-3">
            <p class="paragraph">
              <span class="c0">a)</span> Affinidi Vault Mobile App is the mobile client of the Affinidi Vault. It allows
              consumers to own, collect, store, and share their data in a manner that aligns
              with their pref-erences and values. By using the mobile app, Consumers can securely manage their personal
              data, benefit from passwordless authentication, have the choice of storing their
            ...
            <div class="ms-md-5 ms-4">
              ...
              <p class="paragraph"><span class="c0">ii.</span> Access the profile page and fill, modify or delete the
                profile data</p>
              <p class="paragraph"><span class="c0">iii.</span> Authenticate on a website and share data from his vault
              </p>
            </div>
          </div>
          <p class="paragraph sbold"><span class="c0">2.</span> System Requirements</p>
