...
const titleText = reactive({ x: 0, y: 25, anchor: 0.5, scale: 1, style: { fontFamily: 'Dogica', fontSize: 54 * 0.45, align: 'center', lineHeight: 64 * 0.9, stroke: 1, strokeThickness: 0 } })
    ...
    <template v-if="!isLandscape">
      <Container :x="titleText.x" :y="titleText.y">
        <Text :y="-300" :anchor="titleText.anchor" :scale="titleText.scale"
          :style="{ ...titleText.style, fontFamily: 'DogicaBold' }">
          WELCOME TO\n DATAVILLE
        </Text>
