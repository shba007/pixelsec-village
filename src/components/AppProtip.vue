  ...
  <AppPopup :type="modal.type" :x="modal.x" :y="modal.y" :zoom-factor="zoomFactor" :show-button="false">
    <template v-if="title === '1'">
      ...
      <Container :x="title1Text.x" :y="title1Text.y">
        ...
        <Text :x="183" :y="0" :anchor="title1Text.anchor" :scale="title1Text.scale" :style="{ ...title1Text.style, fill: '#3464FD', stroke: '#3464FD' }">DISCOVER</Text>
        <Text :x="428" :y="0" :anchor="title1Text.anchor" :scale="title1Text.scale" :style="title1Text.style">your</Text>
